...
/*=====================================Requirements===================================*/
    ...
    require_once __DIR__ . "/../../.." . "/System/Scripts/External.inc.php";
...
/*====================================================================================*/
    class Checkout extends Session
    {
        ...
        private function outputs($FLAG = NULL)
        {
            switch ($FLAG)
            {
                ...
                case "Occupied":
                    ...
                    $this->_charges = $charges = $this->settings['charges']['enabled'] ?
        ...
        private function calculateCharges($time_in)
        {
            ...
            $charging_duration = $this->settings['charges']['duration'];
            $charging_cost = $this->settings['charges']['cost'];
        ...
        public function cleanUp()
        {
            ...
            header("refresh:7; url=Checkout.php") or die();
        }
    }
