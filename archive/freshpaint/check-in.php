...
<!--Navbar Section-->
     ...
     <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container">
             ...
             <a class="navbar-brand" href="index.php">NeoDev</a>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-8 py-4 border-0">
                ...
                <button type="button" class="btn btn-secondary btn-lg btn-block">Mall</button>
                <button type="button" class="btn btn-secondary btn-lg btn-block">KFC</button>
                <button type="button" class="btn btn-secondary btn-lg btn-block">Chemist</button>
                <button type="button" class="btn btn-secondary btn-lg btn-block">Parking Space</button>
