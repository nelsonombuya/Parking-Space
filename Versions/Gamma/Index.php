...
<body>
    ...
    <main>
        ...
        <div class="container-fluid banner ">
            ...
            <!-- TODO: Add Javascript Countdown (With a stop function on scroll or page interaction) -->
            <div class="container">
                <div class="card-deck">
                    <div class="card text-center text-white mb-3">
                        <a class="terminal-link text-white text-decoration-none" href="Check-In/Check-In.php">
                    ...
                    <div class="card text-center text-white mb-3 border-0">
                        <a class="checkout-link text-white text-decoration-none" href="Checkout/Checkout.php">
                    ...
                    <div class="card text-center text-white mb-3">
                        <a class="account-link text-white text-decoration-none" href="Management/Account.php">
