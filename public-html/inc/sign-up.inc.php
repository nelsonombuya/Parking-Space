<?php
    ...
    $signup_details['first_name'] = $_POST["First-Name"];
    $signup_details['last_name']  = $_POST["Last-Name"];
    $signup_details['username']   = $_POST["Username"];
    $signup_details['email']   = $_POST["email"];
    $signup_details['number_plate'] = $_POST["numberplate"];
    $signup_details['id_number']   = $_POST["ID-No"];
