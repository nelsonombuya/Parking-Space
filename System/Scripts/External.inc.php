<?php
/*=========================== EXTERNAL SCRIPTS INCLUDE FILE ============================*/
/* NOTE: The contents of this file are functions obtained...                            */
/* from external sources for use in the project                                         */
/*======================================================================================*/

##########################################################################################
/* This is the path for the external scripts folder */
define ('external_scripts', $_SERVER['DOCUMENT_ROOT'] . "/System/Scripts/External/");
